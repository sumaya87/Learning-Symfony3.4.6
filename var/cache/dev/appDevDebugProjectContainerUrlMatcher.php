...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        // list
        if ('/list_posts' === $pathinfo) {
            return array (  '_controller' => 'AppBundle\\Controller\\RedditController::listAction',  '_route' => 'list',);
        }

        // scraper
        if ('/scraper' === $pathinfo) {
            return array (  '_controller' => 'AppBundle\\Controller\\RedditController::scraperAction',  '_route' => 'scraper',);
        }
